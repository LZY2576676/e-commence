          ...
          <div key={index} className='py-4 border-t border-b text-gray-700 flex flex-col md:flex-row justify-between items-center gap-4'>
            <div className='flex items-start gap-6 text-sm'>
              ...
              <div>
                ...
                <div className='flex items-center gap-3 mt-2 text-base text-gray'></div>
            ...
            <div className='md:w-1/2 flex justify-between'>
              ...
              <button className='border px-4 py-2 text-sm font-medium rounded-sm'>View Details</button>
            </div>
          </div>
